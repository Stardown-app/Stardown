...
export function createTextFragmentArg(selection) {
    ...
    switch (result.status) {
        case 1:
            console.warn(
                "The selection provided could not be used to create a text fragment",
            );
            browser.runtime.sendMessage({
                destination: "background",
                category: "showWarning",
        ...
        case 2:
            console.warn(
                "No unique text fragment could be identified for this selection",
            );
            browser.runtime.sendMessage({
                destination: "background",
                category: "showWarning",
        ...
        case 3:
            console.warn(
                "Text fragment computation could not complete in time",
            );
            browser.runtime.sendMessage({
                destination: "background",
                category: "showWarning",
        ...
        case 4:
            console.warn(
                "An exception was raised during text fragment generation",
            );
            browser.runtime.sendMessage({
                destination: "background",
                category: "showWarning",
